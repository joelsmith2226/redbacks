...
class _PickPageState extends State<PickPage> {
  ...
  void tripleCapDialog(BuildContext context) {
    showDialog(context: context, builder: (context) {
      ...
      return AlertDialog(
        title: Text("${tripCapStatus ? "Deactivate" : "Activate"} Triple Captain"),
        content: Text(
          ...
          onPressed: () {
            setState(() {
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('Triple Captain ${tripCapStatus ? "Deactivated" : "Activated"}!'),
              ));
              FirebaseUsers().activateDeactivateChip(user.uid, "triple-cap", !tripCapStatus);
